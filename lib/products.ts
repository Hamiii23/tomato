...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Durable laptop backpack with multiple compartments, USB charging port, and water-resistant material.",
    price: 5499,
    originalPrice: 7999,
    image:
  ...
  },
  {
    ...
    description:
      "Pack of 4 WiFi-enabled smart bulbs. Control via app, voice commands, and set schedules. 16 million colors.",
    price: 4499,
    originalPrice: 5999,
    image:
  ...
  },
  {
    ...
    reviews: 1089,
    inStock: true,
    features: ["1g Accuracy", "5kg Capacity", "Tare Function", "LCD Display"],
  },
  {
    id: "28",
  ...
  },
  {
    ...
    description:
      "7-in-1 USB-C hub with HDMI, USB 3.0 ports, SD card reader, and ethernet. Perfect for laptops.",
    price: 3499,
    originalPrice: 4999,
    image:
    ...
    reviews: 2234,
    inStock: true,
    features: ["7-in-1 Design", "4K HDMI Output", "USB 3.0", "SD Card Reader"],
  },
  {
    id: "31",
    name: "Stainless Steel Cookware Set",
    description:
      "Professional 10-piece stainless steel cookware set with non-stick coating. Induction compatible and oven safe.",
    price: 8999,
    originalPrice: 12999,
    image:
